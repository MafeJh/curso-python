...
name, age, city = "Mafe JH", 27, "Medellín"  # Aunque es posible, no es tan legible como asignar cada variable en una línea separada
...
name: str = "MafeJH" # Indica que la variable es una cadena de texto
print(name)